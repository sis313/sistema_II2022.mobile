...
class BranchEditForm extends StatefulWidget {
  Branch branch;

  BranchEditForm(this.branch);

  @override
  State<BranchEditForm> createState() => _BranchEditFormState(this.branch);
}

class _BranchEditFormState extends State<BranchEditForm> {
  Branch branch;

  _BranchEditFormState(this.branch);
  ...
  Widget build(BuildContext context) {
    /*openTime = branch.openHour as TimeOfDay;
    closeTime = branch.closeHour as TimeOfDay;
    address = branch.address;*/

    return Scaffold(
        appBar: AppBar(
          title: Text("Branch Edition"),
        ...
        body: Flex(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () async {
                print("idBranch es ${branch.idBranch}");
                ...
                print("idBusiness es ${branch.idBusiness}");
                print("createDate es ${branch.createDate}");
                print("updateDate es ${branch.updateDate}");

                DateTime now = new DateTime.now();

                //print(openTime.toString());

                var response = Provider.of<BoActiveProvider>(context, listen: false).updateBranch
                    (branch.idBranch,
                    address,
                ...
                Route route = MaterialPageRoute(builder: (context) => BranchDetail(branch.idBusiness));
